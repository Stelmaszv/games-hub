 ...
 */
final class Version20240606132229 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE publisher (id INT AUTO_INCREMENT NOT NULL, created_by_id INT DEFAULT NULL, general_information JSON NOT NULL, descriptions JSON NOT NULL, creation_date DATETIME NOT NULL, editors JSON NOT NULL, verified TINYINT(1) NOT NULL, INDEX IDX_9CE8D546B03A8386 (created_by_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
